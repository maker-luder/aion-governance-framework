...
TARGET_HEAD = 66feed852e89846468d9b9ef2ce3849d72d75336
...
| Component matrix | 58 eligible records; 55 tested targets; 3 explicit non-applicable targets; 1019 passed; 0 failed targets |
| Branch-native coverage | 55 targets; 0 failed targets |
...
The earlier research targets contributed 10 contextual-authority tests, 9 cross-lineage-contamination tests, 11 replication-epistemics tests, 11 typed-lineage-edge tests, 14 independent-replication-design tests, 11 contextual-authority-adversarial tests, and 13 factorial-completeness tests. The full-authority semantics unit contributed 20 additional passing tests and seven synthetic cases; all declared mechanism checks passed after preserving initial reason-code and contradictory-record failures, then applying conservative corrections.
