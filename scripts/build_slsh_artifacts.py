    ...
    for i, match in enumerate(starts):
        ...
        if source_id in batch01_kinds:
            ...
            if source_id == "S51":
                ...
                disposition = "ADMIT_HIGH_RELEVANCE_AS_METHOD_GUARD"; relation = "CROSS_DOMAIN_ADVERSARIAL_METHOD_TRANSFER"; role = "CROSS_DOMAIN_ADVERSARIAL_METHOD_TRANSFER"; active = "CROSS_DOMAIN_ADVERSARIAL_METHOD_TRANSFER"; guards = []
            audit = {
