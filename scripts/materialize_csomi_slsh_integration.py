...
OUTPUT = ROOT / "research-workbench" / "csomi-slsh-integration-2026-08-14" / "CSOMI_SLSH_INTEGRATION_RECORD_V0.1.0.json"
...
def main() -> None:
    ...
    if slsh.packet.get("base_head") != csomi.spec.authority_sha:
        raise AssertionError("SLSH base_head does not match the pinned CSOMI authority SHA")
