...
- [`CCAP_D1_D4_TEVV_PRE_EXECUTION_DESIGN_2026_09_18.md`](docs/research/CCAP_D1_D4_TEVV_PRE_EXECUTION_DESIGN_2026_09_18.md) 與 [`CCAP_FOUR_DOMAIN_SIX_DIMENSION_CORE_STRESS_TEST_2026_09_18.md`](docs/research/CCAP_FOUR_DOMAIN_SIX_DIMENSION_CORE_STRESS_TEST_2026_09_18.md) —— 把凍結的 D1 × D4 source-partition 問題映射進既有 TEVV／量測結構，並檢查 Four-Domain × 六維的結構相容性；但不把結構完整性誤當成區辨效度或實證支持。
