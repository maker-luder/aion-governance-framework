...
Status: `BOUNDED_IMPLEMENTATION / MERGED_IN_MAIN / CURRENT_ASSURANCE_SURFACE`

Current integration standing:

```text
CURRENT_INTEGRATION_STANDING =
AI_RISK_IMPACT_RECEIPT_INTEGRATED
+ TEVV_RECEIPT_INTEGRATED
+ AI_SECURITY_RECEIPT_INTEGRATED
+ EXACT_MEASUREMENT_SEMANTIC_BINDING_PRESENT

MERGED_IN_MAIN != ISO_CERTIFICATION
CURRENT_ASSURANCE_SURFACE != INDEPENDENT_IVV
QMS_READY_FOR_HUMAN_REVIEW != MERGE_AUTHORITY
ENGINEERING_INTEGRATION != SCIENTIFIC_VALIDATION
```
