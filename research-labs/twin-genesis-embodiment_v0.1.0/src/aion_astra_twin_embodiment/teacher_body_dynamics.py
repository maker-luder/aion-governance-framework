...
def _build_transitions() -> tuple[PhysiologicalTransition, ...]:
    return (
        ...
        PhysiologicalTransition(
            "ENERGY_DEMAND_TO_OREXIGENIC_SIGNAL",
            "FEEDING_ENERGY_REGULATION",
            "ENERGY_BALANCE_REFERENCE",
            "OREXIGENIC_SIGNAL_REFERENCE",
            ("ENERGY_AVAILABILITY_STATE", "OREXIGENIC_SIGNAL_REFERENCE"),
        ),
        PhysiologicalTransition(
            "NUTRIENT_ARRIVAL_TO_SATIATION_SIGNAL",
            "FEEDING_ENERGY_REGULATION",
            "NUTRIENT_ARRIVAL_REFERENCE",
            "SATIATION_SIGNAL_REFERENCE",
            (
                "GASTRIC_DISTENSION_STATE",
                "NUTRIENT_ABSORPTION_STATE",
        ...
        PhysiologicalTransition(
            "SATIATION_TO_SATIETY_SIGNAL",
            "FEEDING_ENERGY_REGULATION",
            "SATIATION_SIGNAL_REFERENCE",
            "SATIETY_SIGNAL_REFERENCE",
            ("SATIATION_SIGNAL_REFERENCE", "SATIETY_SIGNAL_REFERENCE"),
        ),
        PhysiologicalTransition(
            "ENDOCRINE_BASELINE_TO_ADAPTIVE_RESPONSE",
            "ENDOCRINE_DYNAMIC",
            "ENDOCRINE_BASELINE_REFERENCE",
            "ENDOCRINE_RESPONSE_REFERENCE",
            (
...
def _build_homeostatic_variables() -> tuple[HomeostaticVariable, ...]:
    return (
        ...
        HomeostaticVariable(
            ...
            "BOUNDED_REFERENCE_CYCLE",
            "HOMEOSTATIC_AND_ANTICIPATORY_REFERENCE",
        ),
        HomeostaticVariable(
            "ENDOCRINE_AXIS_REGULATION",
            (
                "HYPOTHALAMIC_PITUITARY_STATE",
                "THYROID_AXIS_STATE",
                "ADRENAL_AXIS_STATE",
