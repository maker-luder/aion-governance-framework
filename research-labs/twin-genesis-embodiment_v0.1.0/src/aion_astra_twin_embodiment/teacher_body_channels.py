...
_SIGNAL_CHANNELS: Final[tuple[BodySignalChannel, ...]] = (
    ...
    BodySignalChannel("HEPATIC_NUTRIENT_PROCESSING_STATE", "HEPATIC_INTEROCEPTIVE", "LIVER"),
    BodySignalChannel("HEPATIC_DETOXIFICATION_REFERENCE", "HEPATIC_INTEROCEPTIVE", "LIVER"),
    BodySignalChannel("BILE_PRODUCTION_STATE", "HEPATIC_INTEROCEPTIVE", "LIVER_BILIARY"),
    BodySignalChannel("HEPATIC_GLYCOGEN_STATE", "HEPATIC_INTEROCEPTIVE", "LIVER_METABOLIC"),
    BodySignalChannel("RENAL_FILTRATION_STATE", "RENAL_INTEROCEPTIVE", "KIDNEYS"),
    BodySignalChannel("URINE_PRODUCTION_STATE", "RENAL_INTEROCEPTIVE", "KIDNEYS_URETERS"),
    BodySignalChannel("BLADDER_AFFERENT_STATE", "INTEROCEPTIVE", "BLADDER_WALL"),
    BodySignalChannel("DETRUSOR_CONTRACTION_STATE", "INTEROCEPTIVE", "BLADDER_DETRUSOR"),
    BodySignalChannel(
        "URETHRAL_OUTLET_RELAXATION_STATE",
        "INTEROCEPTIVE",
        "BLADDER_NECK_URETHRA",
    ),
    BodySignalChannel(
    ...
    BodySignalChannel(
        ...
        "INTEROCEPTIVE",
        "LOWER_URINARY_TRACT_NEURAL_CONTROL",
    ),
    BodySignalChannel("URINE_FLOW_STATE", "INTEROCEPTIVE", "URETHRA"),
    BodySignalChannel("HEMATOLOGIC_OXYGEN_TRANSPORT_STATE", "HEMATOLOGIC_INTEROCEPTIVE", "BLOOD"),
    BodySignalChannel("COAGULATION_STATE_REFERENCE", "HEMATOLOGIC_INTEROCEPTIVE", "BLOOD"),
    BodySignalChannel("BLOOD_CELL_TURNOVER_REFERENCE", "HEMATOLOGIC_INTEROCEPTIVE", "BLOOD_MARROW"),
    BodySignalChannel("LYMPHATIC_FLUID_RETURN_STATE", "LYMPHATIC_INTEROCEPTIVE", "LYMPHATIC"),
    BodySignalChannel("SKIN_BARRIER_STATE", "INTEGUMENTARY_INTEROCEPTIVE", "WHOLE_BODY_SKIN"),
    ...
    BodySignalChannel("SEMINAL_TRACT_TRANSPORT_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "EPIDIDYMIS_VAS_DEFERENS_REPRODUCTIVE_TRACT"),
    BodySignalChannel("ACCESSORY_GLAND_SECRETION_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "SEMINAL_VESICLES_PROSTATE_ACCESSORY_GLANDS"),
    BodySignalChannel("BLADDER_NECK_EJACULATORY_CLOSURE_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "BLADDER_NECK_INTERNAL_URETHRAL_OUTLET"),
    BodySignalChannel("POSTERIOR_URETHRAL_SEMINAL_LOAD_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "POSTERIOR_PROSTATIC_URETHRA"),
    BodySignalChannel("EXPULSION_MOTOR_PATTERN_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "PELVIC_STRIATED_MUSCULATURE"),
    BodySignalChannel("EXTERNAL_URETHRAL_SPHINCTER_EJACULATORY_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "EXTERNAL_URETHRAL_SPHINCTER"),
    BodySignalChannel("ANTEGRADE_SEMINAL_FLOW_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "URETHRA_EXTERNAL_OUTPUT"),
    BodySignalChannel("POST_EXPULSION_RECOVERY_STATE", "REPRODUCTIVE_SEXUAL_PHYSIOLOGY", "REPRODUCTIVE_TRACT_PELVIC_FLOOR"),
...
_REQUIRED_REPRODUCTIVE_EVENT_DOMAIN_BY_ID: Final[dict[str, str]] = {
    "SEMINAL_TRACT_TRANSPORT_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "ACCESSORY_GLAND_SECRETION_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "BLADDER_NECK_EJACULATORY_CLOSURE_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "POSTERIOR_URETHRAL_SEMINAL_LOAD_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "EXPULSION_MOTOR_PATTERN_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "EXTERNAL_URETHRAL_SPHINCTER_EJACULATORY_STATE": (
        "REPRODUCTIVE_SEXUAL_PHYSIOLOGY"
    ),
    "ANTEGRADE_SEMINAL_FLOW_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
    "POST_EXPULSION_RECOVERY_STATE": "REPRODUCTIVE_SEXUAL_PHYSIOLOGY",
}


_REQUIRED_SYSTEM_OBSERVATION_DOMAIN_BY_ID: Final[dict[str, str]] = {
    "HEPATIC_NUTRIENT_PROCESSING_STATE": "HEPATIC_INTEROCEPTIVE",
    "HEPATIC_DETOXIFICATION_REFERENCE": "HEPATIC_INTEROCEPTIVE",
    "BILE_PRODUCTION_STATE": "HEPATIC_INTEROCEPTIVE",
    "HEPATIC_GLYCOGEN_STATE": "HEPATIC_INTEROCEPTIVE",
    "RENAL_FILTRATION_STATE": "RENAL_INTEROCEPTIVE",
    "HEMATOLOGIC_OXYGEN_TRANSPORT_STATE": "HEMATOLOGIC_INTEROCEPTIVE",
    "COAGULATION_STATE_REFERENCE": "HEMATOLOGIC_INTEROCEPTIVE",
    "BLOOD_CELL_TURNOVER_REFERENCE": "HEMATOLOGIC_INTEROCEPTIVE",
    "LYMPHATIC_FLUID_RETURN_STATE": "LYMPHATIC_INTEROCEPTIVE",
    "SKIN_BARRIER_STATE": "INTEGUMENTARY_INTEROCEPTIVE",
}
...
def validate_teacher_body_signal_schema(
    ...
    for channel_id, expected_domain in _REQUIRED_SYSTEM_OBSERVATION_DOMAIN_BY_ID.items():
        if channel_by_id[channel_id].domain != expected_domain:
            raise ValueError("physiology system observation channel domain drift")
    for channel_id, expected_domain in _REQUIRED_REPRODUCTIVE_EVENT_DOMAIN_BY_ID.items():
        if channel_by_id[channel_id].domain != expected_domain:
            raise ValueError("reproductive event channel domain drift")
