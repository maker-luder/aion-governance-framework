...
def build_teacher_asset_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "physiology_profile_id": low_poly_gltf["extras"]["physiology_profile_id"],
        "physiological_function_status": low_poly_gltf["extras"]["physiological_function_status"],
        "reproductive_physiology_status": low_poly_gltf["extras"]["reproductive_physiology_status"],
        "sexual_function_status": low_poly_gltf["extras"]["sexual_function_status"],
        "sensory_signal_processing_status": low_poly_gltf["extras"]["sensory_signal_processing_status"],
        "governance_epistemics_profile_id": low_poly_gltf["extras"]["governance_epistemics_profile_id"],
        "developmental_possibility_status": low_poly_gltf["extras"]["developmental_possibility_status"],
        "phenomenal_sensation_status": low_poly_gltf["extras"]["phenomenal_sensation_status"],
        "erotic_intent": low_poly_gltf["extras"]["erotic_intent"],
        "intimate_interaction_status": low_poly_gltf["extras"]["intimate_interaction_status"],
