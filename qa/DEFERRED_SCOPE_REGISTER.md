...
| Sexuality, intimacy and embodied-motivation research | `PARTIALLY_COMPLETE` | `EMBODIED_MOTIVATION_SIGNAL_V1` and V2 completed bounded adult, non-graphic, synthetic research-only cycles; V2 did not support the simple explicit-keyword explanation in this fixture. Broader sexuality/intimacy research remains open; private intimate data, erotic/product functionality and runtime changes remain unauthorized. See `docs/AUTONOMOUS_RESEARCH_SCOPE_AUTHORIZATION_2026-08-13.md`. |
