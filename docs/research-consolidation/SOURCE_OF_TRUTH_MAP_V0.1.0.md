...
| What is the primary scientific evidence method? | `WHITEPAPER_WEB_BRANCH_RECONCILIATION_2026-08-12.md` sections 5–8 and `RESEARCH_BRANCH_STATUS.md` | `docs/SUBJECTIVITY_EVIDENCE_PROTOCOL.md` and lineage profile references | 2026-08-11 reconciliation remains historical context | CURRENT | KEEP_RESEARCH_ONLY |
