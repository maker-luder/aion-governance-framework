...
| `LIT-FAI2R-2026` | Krebs, [F(AI)2R arXiv:2607.25637v2][29] | The paper describes an AI-assisted authoring pass and machine-readable audit pass; its `aiprov` model records attribution per activity/claim and reserves the highest verification rungs for human grantors | VERIFIED | External change-provenance and human-review-ladder comparator | No `aiprov` implementation or authorship system is added | Attribution/provenance is not an AION legal authorship or autonomous authorship conclusion | KEEP_RESEARCH_ONLY |
| `STD-COPE-AI-AUTHORSHIP-2023` | COPE Council, [Authorship and AI tools][30] | COPE states that AI tools cannot be listed as authors because they cannot take responsibility for submitted work; human authors remain responsible and AI use should be disclosed | VERIFIED | External publication-ethics accountability context only | No external policy is adopted as AION authority | Policy position is not an AION authorship rule or scientific result; current change provenance remains role-separated | KEEP_RESEARCH_ONLY |
