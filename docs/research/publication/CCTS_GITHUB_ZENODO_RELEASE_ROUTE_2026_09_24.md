...
```text
ROOT_CITATION_CFF = PRESENT / LIVE-REPOSITORY CLEANUP STAGED IN PR #207
...
DOI = NO
ROOT_CITATION_STALE_BINDING_CLEANUP = YES_ON_PREPARATION_BRANCH
CCTS_PREFERRED_CITATION = NO
```
