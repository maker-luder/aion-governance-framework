# Human–AI learning, CCTS dynamic observation, and HTECR external crosswalk / falsification plan — 2026-09-18

Status: `RESEARCH_HYPOTHESIS / EXTERNAL_LITERATURE_CROSSWALK / METHODS_PLAN`
...
HTECR_WORKING_LABEL != VALIDATED_CONSTRUCT
HIGH_THROUGHPUT != HIGH_QUALITY
INTERACTION_PATTERN != MODEL_INTERNAL_STATE
INTERACTION_PATTERN != SHARED_MIND
CCTS_DYNAMIC_REGIME != AI_SUBJECTIVITY
...
The Human Owner supplied the original observation and source-language distinction:
...
The ChatGPT Teacher supplied the repository working label:
...
This is a **local working label**, not an externally established scientific term.

The Teacher also proposed the preliminary structural distinction:

```text
CCTS
= interaction-and-artifact structure

HTECR
= candidate dynamic interaction regime within / across such a structure
```
...
`d9171232f5efb0de889b26548d89b4be0e4cf03a`

Existing canonical material already covers important ancestry and must not be relabeled as new:
...
Therefore the new gap is **not** “Human–AI learning exists” and is **not** “CCTS exists.” The narrower gap is whether a measurable dynamic coordination regime can be separated from existing structural and continuity constructs.
...
"aion-governance-framework" + arXiv
"aion-governance-framework" + DOI
"aion-governance-framework" + research
```
...
!= NOBODY_HAS_READ_THE_REPOSITORY
!= NO_UNPUBLISHED_DISCUSSION
!= NO_FUTURE_CITATION
```
...
The following sources establish neighboring research areas. Conceptual overlap does not establish identity with CCTS or HTECR.

### 5.1 Human–AI mutual learning

Wang, X. & Chen, X. (2024), **Towards Human-AI Mutual Learning: A New Research Paradigm**, arXiv:2405.04687.
...
### 5.2 Interactive Team Cognition (ITC)
...
```text
INTERACTION_LEVEL_COGNITIVE_ACTIVITY_IS_AN_ESTABLISHED_RESEARCH_PERSPECTIVE = YES
CCTS_OR_HTECR_IS_EQUIVALENT_TO_ITC = NO
HUMAN_AI_DYAD_IS_A_HUMAN_TEAM_IN_THE_ORIGINAL_ITC_SENSE = NOT_ASSUMED
```

### 5.3 Human–AI team cognition

Narayanan, R., Cohen, M. C., Feigh, K. M., & Cooke, N. J. (2025), **Two Sides of the Same Coin? Joint Perspectives From Shared Mental Models and Interactive Team Cognition Theories on Human-AI Team Cognition**, *Proceedings of the Human Factors and Ergonomics Society Annual Meeting*. DOI: `10.1177/10711813251358788`.

Primary source: https://doi.org/10.1177/10711813251358788

This paper explicitly applies Shared Mental Model and Interactive Team Cognition perspectives to Human–AI teams.

Bounded implication:

```text
TEAM_COGNITION_FRAMEWORKS_HAVE_ALREADY_BEEN_EXTENDED_TO_HUMAN_AI = YES
HTECR_NOVELTY_FROM_SIMPLY_STUDYING_HUMAN_AI_INTERACTION = NO
```

### 5.4 Human–AI collaborative learning interaction patterns

Dang, B., Huynh, L., Gul, F., Rosé, C., Järvelä, S., & Nguyen, A. (2025), **Human–AI collaborative learning in mixed reality: Examining the cognitive and socio-emotional interactions**, *British Journal of Educational Technology*, 56, 2078–2101. DOI: `10.1111/bjet.13607`.
...
```text
HUMAN_AI_LEARNING_INTERACTION_PATTERNS_CAN_BE_EMPIRICALLY_ANALYZED = YES
OUR_LONGITUDINAL_PATTERN_IS_ALREADY_VALIDATED_BY_THIS_STUDY = NO
```
...
Samuel, A. (2026), **Learning with machines: Toward a theory of epistemic co-agency**, *Computers and Education: Artificial Intelligence*, 10, 100573. DOI: `10.1016/j.caeai.2026.100573`.

Primary source: https://doi.org/10.1016/j.caeai.2026.100573

The paper proposes a theory-informed framework in which learners engage AI outputs dialectically by challenging assumptions, surfacing contradictions and maintaining epistemic responsibility.

Bounded implication:

```text
REASON_WITH_AND_AGAINST_AI_IS_AN_EXTERNAL_THEORETICAL_DIRECTION = YES
EPISTEMIC_CO_AGENCY_IS_EMPIRICALLY_SETTLED = NO
CCTS_HTECR = EPISTEMIC_CO_AGENCY = NO
```

### 5.6 Epistemic dependence and preserved judgement

Du, Y. & Yuan, Y. (2026), **Epistemic dependence in AI-mediated learning**, *AI & Society*. DOI: `10.1007/s00146-026-03294-1`.

Primary source: https://doi.org/10.1007/s00146-026-03294-1

The review distinguishes productive reliance from harmful dependence and centers contestability, recoverability, transfer, traceability, distributed responsibility and epistemic plurality.
...
## 6. Revised research gap

The external literature falsifies an overly broad novelty claim.

Rejected / narrowed claim:

```text
"Human–AI Learning itself is our research gap"
= REJECTED_AS_TOO_BROAD
```
...
+ QUALITY_BOUNDED
HUMAN_AI_EPISTEMIC_DEVELOPMENT
```
...
```text
UNIT_OF_ANALYSIS
= HUMAN_AI_INTERACTION_TRAJECTORY
```
...
The coding scheme must preserve actor provenance:
...
MISSED_CONSTRAINT_RATE
REPAIR_RATE
BRANCH_REINFLATION_RATE
...
Use existing consented interaction traces and repository artifacts where permitted. Do not infer hidden model states.

Required outputs:

1. timestamped event segmentation;
...
-> CODE_NEGATIVE_CONTROLS
-> TEST_DISCRIMINANT_VALUE
-> RECORD_INCONCLUSIVE_OUTCOME_IF_NEEDED
-> ONLY_THEN_CONSIDER_CONFIRMATORY_STUDY
```
...
CONFIRMATORY_EXECUTION_AUTHORIZATION = NONE
SCIENTIFIC_DISPOSITION = HOLD
```
