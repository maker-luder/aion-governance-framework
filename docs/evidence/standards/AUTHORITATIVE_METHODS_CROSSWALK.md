...
| ISO/IEC 27090 (Edition 1; official ISO status on 2026-09-18: stage 60.00, under publication) | AI-specific cybersecurity threats and mitigations across the AI lifecycle, including poisoning and model theft | Use as a versioned security-method anchor for AI-specific threat applicability, protected assets, detection, mitigation and lifecycle review | Under-publication status and method use do not establish ISO conformance, certification or completed implementation |
...
- ISO/IEC 27090, *Cybersecurity — Artificial Intelligence — Addressing security threats and compromises to artificial intelligence systems* (Edition 1, under publication at ISO stage 60.00 on 2026-09-18).
