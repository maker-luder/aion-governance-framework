...
| `main` | `e079fb7dfe7a04be7dcb94b8a059951a003caa94` | `e079fb7dfe7a04be7dcb94b8a059951a003caa94` | 0 / 0 | 0 | — | `PRESERVE_AS_FROZEN_AUTHORITY` | No | Protected default branch; no direct mutation performed. |
...
| `promotion/csomi-slsh-integration-selective-20260815` | `ce0fa4899a9498d7795d4da9b5f96ba3570c3ead` | `e079fb7dfe7a04be7dcb94b8a059951a003caa94` | 2 / 0 | 2 | #19, closed | `DEFERRED_NOT_PROMOTED` | No; tag first | Authority Gate is HOLD; PR #19 was formally closed without merge. |
...
```text
REMOTE_BRANCHES_INVENTORIED = 13
REMOTE_BRANCHES_DELETED = 0
UNIQUE_HISTORY_DELETED = 0
FROZEN_AUTHORITY_REFS_DELETED = 0
RESEARCH_PROVENANCE_DELETED = 0
TAG_CREATION = HOLD_FOR_OWNER
WHOLESALE_RESEARCH_MERGE = FORBIDDEN_AND_NOT_PERFORMED
CANONICAL_EFFECT = NONE
```

The machine-readable companion is [`FINAL_BRANCH_DISPOSITION_2026-08-15.json`](FINAL_BRANCH_DISPOSITION_2026-08-15.json).
