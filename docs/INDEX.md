...
- [`../examples/classical-western-astrology_v0.1.0/README.md`](../examples/classical-western-astrology_v0.1.0/README.md) — synthetic-only classical Western astrology fact derivation and non-claims.
