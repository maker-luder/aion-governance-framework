...
- [`research/CCTS_ADVERSARIAL_EPISTEMIC_REVISION_LOOP_2026_09_23.md`](research/CCTS_ADVERSARIAL_EPISTEMIC_REVISION_LOOP_2026_09_23.md) — bounded CCTS challenge/revision extension for counterexamples, hidden assumptions, bypass paths, alternative explanations, grounding and research-necessity challenges, falsifiers, explicit revision dispositions, rejected-branch preservation and claim ceilings; structural revision is not Human conceptual change or learning.
