...
- [`research/EPISTEMIC_NORMATIVE_RUPTURE_RECONSTRUCTION_CROSSWALK_2026_09_23.md`](research/EPISTEMIC_NORMATIVE_RUPTURE_RECONSTRUCTION_CROSSWALK_2026_09_23.md) — documentation-only repository/external crosswalk for epistemic reliance rupture, normative-source failure, coercive-adaptation abstractions, embodiment gaps and QMS drift candidates; includes an open-ended Work/Codex research mandate and does not authorize implementation.
