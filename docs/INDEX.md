...
- [`research/CCTS_ADVERSARIAL_EPISTEMIC_REVISION_PROTOCOL_2026_09_23.md`](research/CCTS_ADVERSARIAL_EPISTEMIC_REVISION_PROTOCOL_2026_09_23.md) — higher-rigor CCTS challenge profile: typed counterevidence / counterexample / hidden-assumption / bypass / grounding / necessity / falsifier challenges, verified conceptual-revision traces, rejected-branch and claim-ceiling binding, with no Human-learning or subjectivity promotion.
- [`superpowers/specs/2026-09-24-ccts-relational-continuity-evidence-lane-design.md`](superpowers/specs/2026-09-24-ccts-relational-continuity-evidence-lane-design.md) — approved Option-C design: relational continuity remains a separate, claim-local evidence lane and does not become a universal CCTS admission field.
