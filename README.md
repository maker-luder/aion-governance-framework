...
The current answer is deliberately conservative:
...
- **I have one minute:** [`docs/RESEARCH_MAP.md`](docs/RESEARCH_MAP.md)
...
- **I want the complete documentation map:** [`docs/INDEX.md`](docs/INDEX.md)

For exact-commit engineering status, use live GitHub / CI evidence rather than static prose.

## Engineering and interoperability

- Install / quickstart: [`docs/INSTALLATION.md`](docs/INSTALLATION.md), [`docs/QUICKSTART.md`](docs/QUICKSTART.md)
